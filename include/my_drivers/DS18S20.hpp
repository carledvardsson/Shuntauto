...
class DS18S20{
    ...
    public:
        ...
        DS18S20(int BusPin,int maxDevices);
        /**
         ...
         * @param addr_list   A pointer to an array of ds18x20_addr_t values.  This
         ...
         * equal to, or more than `addr_count`, depending on how many ds18x20 devices
         * are attached to the bus.
         */
        int ds18x20_scan_devices();
         ...
         */
        esp_err_t ds18x20_measure(bool wait);
        esp_err_t ds18x20_measure(ds18x20_addr_t addr, bool wait);
         ...
         * @returns `ESP_OK` if the command was successfully issued
         */
        esp_err_t ds18x20_read_temperature(ds18x20_addr_t addr, float *temperature);
         ...
         */
        esp_err_t ds18x20_read_temp_multi(ds18x20_addr_t *addr_list, int addr_count, float *result_list);
         ...
         *  @param temperature The temperature in degrees Celsius
         */
        esp_err_t ds18x20_measure_and_read(ds18x20_addr_t addr, float *temperature);
         ...
         * @returns `ESP_OK` if all temperatures were fetched successfully
         */
        esp_err_t ds18x20_measure_and_read_multi(ds18x20_addr_t *addr_list, int addr_count, float *result_list);
         ...
         * @returns `ESP_OK` if the command was successfully issued
         */
        esp_err_t ds18x20_read_scratchpad(ds18x20_addr_t addr, uint8_t *buffer);
        void ds1820_readAll();
};
