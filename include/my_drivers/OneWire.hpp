...
// Lånad från internet, 1-Wire protokollet är lite stökigt att implementera själv.
class OneWire{
    private:
    ...
    public:
        ...
        */
         ...
         */
        static bool onewire_select(gpio_num_t pin, const onewire_addr_t addr);
         ...
         *         `false` if there was an error.
         */
        static bool onewire_skip_rom(gpio_num_t pin);
         ...
         */
        static bool onewire_write(gpio_num_t pin, uint8_t v);
         ...
         */
        static bool onewire_write_bytes(gpio_num_t pin, const uint8_t *buf, size_t count);
         ...
         */
        static int onewire_read(gpio_num_t pin);
         ...
         */
        static bool onewire_read_bytes(gpio_num_t pin, uint8_t *buf, size_t count);
         ...
         * @return `true` on success, `false` on error.
         */
        static bool onewire_power(gpio_num_t pin);
         ...
         * @param[in] pin    The GPIO pin connected to the 1-Wire bus.
         */
        static void onewire_depower(gpio_num_t pin);
         ...
         */
        static void onewire_search_start(onewire_search_t *search);
         ...
         */
        static void onewire_search_prefix(onewire_search_t *search, uint8_t family_code);
         ...
         * garbage.
         */
        static onewire_addr_t onewire_search_next(onewire_search_t *search, gpio_num_t pin);
         ...
         */
        static bool onewire_check_crc16(const uint8_t* input, size_t len, const uint8_t* inverted_crc, uint16_t crc_iv);
         ...
         */
        static uint16_t onewire_crc16(const uint8_t* input, size_t len, uint16_t crc_iv);
